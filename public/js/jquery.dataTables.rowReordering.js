            ...
            $("tbody", oTable).disableSelection().sortable({
                ...
                update: function (event, ui) {
                    ...
                    if (properties.sURL != null) {
                        ...
                        if (properties.sDynamicDatas != null) {
                            var rowNumber = ui.item.context.id.substr(ui.item.context.id.lastIndexOf("_"));
                            $.each(properties.sDynamicDatas, function (index, value)
                            {
                                dynamicParams[index] = $("#"+value+"_"+rowNumber).html();
                            });
                        }
                        //OWN CODE END

...
use BikeStore\Form\InputFilter\BicycleInputFilter;
use BikeStore\Form\InputFilter\BikePartInputFilter;
...
class BicycleFilterForm extends ArticleFilterForm
{
	...
	public function addEssentials()
	{
		...
		$this->setInputFilter(new BicycleInputFilter());
		$this->setHydrator(new BicycleFilterHydrator());
	}
